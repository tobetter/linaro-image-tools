...
class AndroidMx53LoCoConfig(AndroidBoardConfig, Mx53LoCoConfig):
    ...
    _extra_serial_opts = 'console=tty0 console=%s,115200n8' % Mx53LoCoConfig.serial_tty
    android_specific_args = 'init=/init androidboot.console=%s' % Mx53LoCoConfig.serial_tty
    mmc_part_offset = 0
