...
# boot partition; at least 128 MiB; XXX this shouldn't be hardcoded
BOOT_MIN_SIZE_S = align_up(128 * 1024 * 1024, SECTOR_SIZE) / SECTOR_SIZE
# root partition; at least 128 MiB; XXX this shouldn't be hardcoded
...
class OmapConfig(BoardConfig):
    ...
    def _make_boot_files(cls, uboot_parts_dir, boot_cmd, chroot_dir,
        ...
        print "install omap boot loader"
